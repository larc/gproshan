...
| Build Type | Status |
| --- | --- |
| `Linux Ubuntu 18.04` | [![Build Status](https://travis-ci.com/larc/gproshan_dev.svg?token=t9aCnytCvpecrZv3sMxq&branch=raytracing)](https://travis-ci.com/larc/gproshan_dev) |
