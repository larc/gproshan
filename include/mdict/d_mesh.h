...
distance_t mesh_reconstruction(che * mesh, size_t M, std::vector<patch> & patches, std::vector<vpatches_t> & patches_map, a_mat & A, a_mat & alpha, distance_t * dist, const index_t & v_i = 0);
