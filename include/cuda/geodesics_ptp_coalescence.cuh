...
__global__
void relax_ptp_coalescence(CHE * mesh, real_t * new_dist, real_t * old_dist, index_t * new_clusters, index_t * old_clusters, index_t end, index_t start = 0);

__global__
void relax_ptp_coalescence(CHE * mesh, real_t * new_dist, real_t * old_dist, index_t end, index_t start = 0);
